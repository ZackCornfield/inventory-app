...
const createTable = `CREATE TABLE IF NOT EXISTS inventory ( 
    ...
    price DECIMAL(5, 2), 
    brand VARCHAR(50), 
    src TEXT DEFAULT '/images/fork-knife-default.svg', 
    description VARCHAR(200), 
    isDefault BOOLEAN
);`;

const createData = `INSERT INTO inventory (name, category_id, quantity, price, brand, src, description, isdefault) VALUES
